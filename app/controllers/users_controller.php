...
class UsersController extends AppController
{
    ...
    public function import($courseId = null, $importFrom = 'file')
    {
        ...
        if ($importFrom == 'canvas') {
            ...
            $this->set('breadcrumb', $this->breadcrumb->push(__('Import Instructors/TAs/Students from Canvas', true)));
        ...
        if (!empty($this->data)) {
            ...
            if (!empty($instructorUsers)) {
                $resultInstructors = $this->User->addUserByArray($instructorUsers, true, '3');
            }
